...
<body>
   ...
   <div class="main">  <!--The main page-->
<p> <b>Welcome,</b> <?php    //Welcome message on homepage
     
    //make connection
      mysql_connect('localhost','root','');
    //selectdb
    mysql_select_db('library');
        $sql="select * from librarian where fname='".$_SESSION['user']."'";
        $records=mysql_query($sql);
   while($info=mysql_fetch_assoc($records))
   {
    echo " ".$info['fname'];
    }
    ?><br> Thank you for using A.B Library System. </p>
