...
<link href="https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css" rel="stylesheet" integrity="sha384-wvfXpqpZZVQGK6TAh5PVlGOfQNHSoD2xbE+QkPxCAFlNEevoEH3Sl0sibVcOQVnN" crossorigin="anonymous"> 
 <?php 
$conpass=$email=$address=$department=$insertxt=$user=$fname=$mname=$lname=$pass="";//Variable used for storing form data 
 $conpasserr=$emailerr=$addresserr=$depoerr=$usererr=$fnameerr=$mnameerr=$lnameerr=$passerr=""; //Error variables
  ...
  $fnameerr = "Only letters is allowed";
    $lnameerr = "Only letters is allowed";
     $mnameerr = "Only letters is allowed";
            ...
            else  if ($pass==$conpass &&($_POST['user'])&&($_POST['fname'])&&($_POST['mname'])&&($_POST['lname'])&&($_POST['pass'])&&($_POST['conpass'])&&($_POST['depo'])&&($_POST['address'])&&($_POST['email']))
        {
          $conpasserr="Password is confirmed";
             
                $sql="insert into student (id,fname,mname,lname,email,address,department,pass,conpass,active)values('$id','$fname','$mname','$lname','$email','$address','$department','$pass','$conpass','yes')";
...
<caption style="caption-side: top;background-color:#D6EAF8;" ><h4>Sign Up Form</h4></caption>
    <tr>
...
<td> <b>Password</b></td><td><input type="password" name="pass" placeholder="Enter Password" maxlength="12" pattern=".{6,}" title="Only 6 to 9 characters"><br> <span class="error">* <?php echo $passerr;?></span></td>
     ...
     <tr>
<td> <b>Confirm Password</b></td><td><input type="password" name="conpass" placeholder="Confirm Password" maxlength="12" pattern=".{6,}" title="Only 6 to 9 characters"><br> <span class="error">* <?php echo $conpasserr;?></span></td>
     </tr>  
       <tr>
<td><input type="submit" name="add" value="Sign Up"></td>
